...
for i in range(len(filtered_data)):
    ...
    # For subsequent time_stamps
        ...
        '''
        #-------------NMD limit adjust-----------------
        # Check NMD limit as 60*230*0.25
        if grid_energy[i-1] + grid_energy[i] > -3450:
            grid_energy_temp = grid_energy[i]
            grid_energy[i] = -3450 - grid_energy[i-1]
            if grid_energy[i] < grid_energy_temp:
                 grid_energy[i] = grid_energy_temp
            else:
                 grid_energy[i] = grid_energy[i]    
        ''' 
...
data_to_append.to_csv('Final_Data_Bat_2A.csv', index=False, header=True)
